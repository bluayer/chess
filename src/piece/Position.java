...
public class Position {
  ...
  /**
   * Judge If the piece is out of the board or not
   * returns boolean 
   * 
   * @return boolean
   */
   ...
   * 
   * R means it's for Red and Green.
   * R is standard of Red(starting at West)
   * 
   */
  ...
  public enum Direction {
    ...
    WNNE(1, 2), WNNW(-1, 2), WSSE(1, -2), WSSW(-1 ,-2), WEEN(2, 1), WEES(2, -1), WWWN(-2, 1), WWWS(-2 ,-1), // Standard of White and Black 
    
    RN(1, 0), RS(-1, 0), RE(0, 1), RW(0, -1),
    
    RNE(1, 1), RNW(1, -1), RSE(-1, 1), RSW(-1, -1),
    
    RNNE(2, 1), RNNW(2, -1), RSSE(-2, 1), RSSW(-2 ,-1), REEN(1, 2), REES(-1, 2), RWWN(1, -2), RWWS(-1 ,-2); // Standard of Red and Green
  ...
  /**
   * It's for finding Position with direction in valid board.
   * It will use in PosManage for finding ways that piece can move.
   * 
   * 
   * @param Direction direction
